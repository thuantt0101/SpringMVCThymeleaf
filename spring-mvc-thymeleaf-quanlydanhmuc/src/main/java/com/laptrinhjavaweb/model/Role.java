...
@Entity
@Table(name = "role")
@NamedStoredProcedureQueries(@NamedStoredProcedureQuery(name = "getAllRoleByUserName", procedureName = "get_All_Role_By_Username", resultClasses = Role.class,parameters = {
